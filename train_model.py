...
test_img=cv2.imread(r'E:\project\kamal.jpg')  #Give path to the image which you want to test
...
faces,faceID=fr.labels_for_training_data(r'E:\project\dataset') #Give path to the train-images folder which has both labeled folder as 0 and 1
